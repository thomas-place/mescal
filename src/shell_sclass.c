...
void print_info_input(int i, FILE* out) {
    ...
    case AUTOMATA:
    {
        automata* nfa = objects[i]->theob.aut;
...
void print_infoclass_at(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of AT  : Boolean combinations of languages of the form A*aA* where a ∊ A is a letter.");
...
void print_infoclass_att(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of ATT : Boolean combinations of languages of the form (A*aA*)ᵏ where a ∊ A is a letter");
...
void print_infoclass_lt(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of LT : Boolean combinations of languages of the form wA*, A*w and A*wA* where w ∊ A*");
...
void print_infoclass_ltt(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of LTT : Boolean combinations of languages of the form wA*, A*w and F(w,k) where w ∊ A*");
...
void print_infoclass_sf(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of SF : Languages that can be defined by a star-free expression (the Kleene star is");
...
void print_infoclass_amt(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of AMT : Boolean combinations of languages which count the occurrences of some letter");
...
void print_infoclass_mod(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of MOD : Finite unions of languages of the form (Aⁿ)*Aᵏ where n > k ≥ 1 (membership of");
    print_dline_box(0, out, "    a word in the language depends only on its length modulo a fixed integer).");
    print_dline_box(0, out, " Characterizations :");
    print_dline_box(0, out, "  - Languages with a syntactic morphism into a group which maps every a ∊ A to the same element.");
    print_dline_box(0, out, "  - Languages with a minimal automaton which a permutation automaton in which every letter a ∊ A");
...
void print_infoclass_st(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of the class ST : trivial class consisting of the languages ∅ and A*.");
    print_dbot_line(100, out);
}
...
void print_infoclass_pt(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of PT  : Boolean combinations of marked concatenations of the language A*.");
    print_dline_box(0, out, " Characterizations :");
...
void print_infoclass_ppt(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of PPT : Finite unions of marked concatenations of the language A*.");
    print_dline_box(0, out, " Characterizations :");
    ...
    print_dline_box(0, out, "  - Languages with an syntactic ordered monoid M satisfying the equation 1 ≤ s for all s ∊ M.");
    print_dbot_line(100, out);
}
...
void print_infoclass_ul(FILE* out) {
    ...
    print_dline_box(0, out, " Definition of UL  : Finite disjoint unions of unambiguous marked products of languages of the form");
...
static void print_oper_name(com_keyword op, FILE* out) {
    switch (op) {
    case OP_SFC:
        print_dline_box(0, out, " Star-free closure (𝒞 ↦ SF(𝒞)) : SF(𝒞) is the least class containing 𝒞 and closed under union,");
        print_dline_box(0, out, "    complement and marked concatenation.");
        break;
    case OP_TLC2:
        print_dline_box(0, out, " Combined operator (𝒞 ↦ TL₂(𝒞)) : by definition, TL₂(𝒞) = TL(TL(𝒞)).");
    case OP_TLC:
        print_dline_box(0, out, " Unary temporal logic (𝒞 ↦ TL(𝒞)) : TL(𝒞) consists of all languages that can be defined by a formula");
        print_dline_box(0, out, "    of unary temporal logic with modalities parameterized by languages in 𝒞.");
        break;
    case OP_FLC2:
        print_dline_box(
            0, out,
    ...
    case OP_FLC:
        ...
        print_dline_box(0, out, "     formula of future unary temporal logic with modalities parameterized by languages in 𝒞.");
        break;
    case OP_PLC2:
        print_dline_box(0, out, " Combined operator (𝒞 ↦ PL₂(𝒞)) : by definition, PL₂(𝒞) = PL(PL(𝒞)).");
    case OP_PLC:
        print_dline_box(0, out, " Past unary temporal logic (𝒞 ↦ PL(𝒞)) : PL(𝒞) consists of all languages that can be defined by a");
        print_dline_box(0, out, "     formula of past unary temporal logic with modalities parameterized by languages in 𝒞.");
        break;
    case OP_POL:
        print_dline_box(0, out, " Polynomial closure (𝒞 ↦ Pol(𝒞)) : Pol(𝒞) consists of finite unions of marked products of languages");
        print_dline_box(0, out, "     in 𝒞.");
        break;
    case OP_POL2:
        print_dline_box(0, out, " Combined operator (𝒞 ↦ Pol₂(𝒞)) : by definition, Pol₂(𝒞) = Pol(BPol(𝒞)).");
        print_dline_box(0, out, " Polynomial closure (𝒞 ↦ Pol(𝒞)) : Pol(𝒞) consists of finite unions of marked products of languages");
        print_dline_box(0, out, "     in 𝒞.");
    case OP_BPOL:
        print_dline_box(0, out, " Boolean polynomial closure (𝒞 ↦ BPol(𝒞)) : BPol(𝒞) consists of Boolean combinations of marked");
        print_dline_box(0, out, "     products of languages in 𝒞.");
        break;
    case OP_UBPOL:
        print_dline_box(0, out, " Combined operator (𝒞 ↦ UPol(BPol(𝒞)).");
        print_dline_box(0, out, " Unambiguous polynomial closure (𝒞 ↦ UPol(𝒞)) : UPol(𝒞) consists of finite disjoint unions of");
        print_dline_box(0, out, "     unambiguous marked products of languages in 𝒞.");
        print_dline_box(0, out, " Boolean polynomial closure (𝒞 ↦ BPol(𝒞)) : BPol(𝒞) consists of Boolean combinations of marked");
        print_dline_box(0, out, "     products of languages in 𝒞.");
        break;
    case OP_UBPOL2:
        print_dline_box(0, out, " Combined operator (𝒞 ↦ UPol(BPol₂(𝒞)) : by definition, UPol(BPol₂(𝒞)) = UPol(BPol(BPol(𝒞))).");
        print_dline_box(0, out, " Unambiguous polynomial closure (𝒞 ↦ UPol(𝒞)) : UPol(𝒞) consists of finite disjoint unions of");
        print_dline_box(0, out, "     unambiguous marked products of languages in 𝒞.");
        print_dline_box(0, out, " Boolean polynomial closure (𝒞 ↦ BPol(𝒞)) : BPol(𝒞) consists of Boolean combinations of marked");
        print_dline_box(0, out, "     products of languages in 𝒞.");
...
void print_infooper_tl(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: unary temporal logic closure of ST (TL(ST)).");
        ...
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: unary temporal logic closure of DD (TL(DD)).");
        print_oper_name(OP_TLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Unambiguous polynomial closure of the level one in the dot-depth hierarchy (UPol(BPol(DD))).");
        ...
        break;
    case CL_AT:
        print_dtitle_box(10, false, out, 1, "Membership: unary temporal logic closure of AT (TL(AT)).");
        print_oper_name(OP_TLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(ST)-orbits are in DA.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose AT-orbits are in DA.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1, "Membership: unary temporal logic closure of MOD (TL(MOD)).");
        print_oper_name(OP_TLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Unambiguous polynomial closure of the level one in modulo hierarchy (UPol(BPol(MOD))).");
        print_dline_box(0, out, "  - Two-variable first-order logic with the linear order and the modular predicates (FO²(<,MOD)).");
        print_dline_box(0, out, "  - Level Δ₂(<,MOD) in the alternation hierarchy of first-order logic with the linear order and the");
    ...
    case CL_MODP:
        ...
        print_dline_box(0, out, "  - Level Δ₂(<,MOD) in the alternation hierarchy of first-order logic with the linear order, the");
        ...
        break;
    case CL_GR:
        print_dtitle_box(10, false, out, 1, "Membership: unary temporal logic closure of GR (TL(GR)).");
        print_oper_name(OP_TLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Unambiguous polynomial closure of the level one in group hierarchy (UPol(BPol(GR))).");
        print_dline_box(0, out, "  - Two-variable first-order logic with the linear order and the group predicates (FO²(<,GR)).");
        print_dline_box(0, out, "  - Level Δ₂(<,GR) in the alternation hierarchy of first-order logic with the linear order and the");
...
void print_infooper_tl2(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested temporal hierarchy of basis ST (TL₂(ST)).");
        ...
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested temporal hierarchy of basis DD (TL₂(DD)).");
        print_oper_name(OP_TLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose LT-orbits are in DA.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(DD)-orbits are in DA.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(DD)-orbits are in DA.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested temporal hierarchy of basis MOD (TL₂(MOD)).");
        print_oper_name(OP_TLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(MOD)-orbits are in DA.");
        print_dbot_line(100, out);
        break;
    case CL_MODP:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested temporal hierarchy of basis MOD⁺ (TL₂(MOD⁺)).");
        ...
        break;
    case CL_GR:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested temporal hierarchy of basis GR (TL₂(GR)).");
        print_oper_name(OP_TLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(GR)-orbits are in DA.");
        print_dbot_line(100, out);
        break;
    default:
        break;
...
void print_infooper_fl(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: future unary temporal logic closure of ST (FL(ST)).");
        ...
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: future unary temporal logic closure of DD (FL(DD)).");
        print_oper_name(OP_FLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        break;
    case CL_AT:
        print_dtitle_box(10, false, out, 1, "Membership: future unary temporal logic closure of AT (FL(AT)).");
        print_oper_name(OP_FLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose AT-orbits are L-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1, "Membership: future unary temporal logic closure of MOD (FL(MOD)).");
        print_oper_name(OP_FLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
    ...
    case CL_MODP:
        ...
        break;
    case CL_GR:
        print_dtitle_box(10, false, out, 1, "Membership: future unary temporal logic closure of GR (FL(GR)).");
        print_oper_name(OP_FLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
...
void print_infooper_fl2(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested future temporal hierarchy of basis ST (FL₂(ST)).");
        print_oper_name(OP_FLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis AT (FL(AT)).");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis BPol(ST) (FL(BPol(ST))).");
        print_dline_box(0, out, "  - Level two in the nested future temporal hierarchy of basis ST (FL₂(ST)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(ST)-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(ST)-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose AT-orbits are L-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested future temporal hierarchy of basis DD (FL₂(DD)).");
        print_oper_name(OP_FLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis LT (FL(LT)).");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis BPol(DD) (FL(BPol(DD))).");
        print_dline_box(0, out, "  - Level two in the nested future temporal hierarchy of basis DD (FL₂(DD)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose LT-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(DD)-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose FL(DD)-orbits are L-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested future temporal hierarchy of basis MOD (FL₂(MOD)).");
        print_oper_name(OP_FLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis BPol(MOD) (FL(BPol(MOD))).");
        print_dline_box(0, out, "  - Level two in the nested future temporal hierarchy of basis MOD (FL₂(MOD)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(MOD)-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose FL(MOD)-orbits are L-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_MODP:
        ...
        break;
    case CL_GR:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested future temporal hierarchy of basis GR (FL₂(GR)).");
        print_oper_name(OP_FLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested future temporal hierarchy of basis BPol(GR) (FL(BPol(GR))).");
        print_dline_box(0, out, "  - Level two in the nested future temporal hierarchy of basis GR (FL₂(GR)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(GR)-orbits are L-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose FL(GR)-orbits are L-trivial.");
        print_dbot_line(100, out);
        break;
    default:
        break;
...
void print_infooper_pl(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: past unary temporal logic closure of ST (PL(ST)).");
        ...
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: past unary temporal logic closure of DD (PL(DD)).");
        print_oper_name(OP_PLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        break;
    case CL_AT:
        print_dtitle_box(10, false, out, 1, "Membership: past unary temporal logic closure of AT (PL(AT)).");
        print_oper_name(OP_PLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        ...
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose AT-orbits are R-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1, "Membership: past unary temporal logic closure of MOD (PL(MOD)).");
        print_oper_name(OP_PLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
    ...
    case CL_MODP:
        ...
        break;
    case CL_GR:
        print_dtitle_box(10, false, out, 1, "Membership: past unary temporal logic closure of GR (PL(GR)).");
        print_oper_name(OP_PLC, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
...
void print_infooper_pl2(com_keyword c, FILE* out) {
    switch (c) {
    case CL_ST:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested past temporal hierarchy of basis ST (PL₂(ST)).");
        print_oper_name(OP_PLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested past temporal hierarchy of basis AT (PL(AT)).");
        print_dline_box(0, out, "  - Level one in the nested past temporal hierarchy of basis BPol(ST) (PL(BPol(ST))).");
        print_dline_box(0, out, "  - Level two in the nested past temporal hierarchy of basis ST (PL₂(ST)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose TL(ST)-orbits are R-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(ST)-orbits are R-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose AT-orbits are R-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_DD:
        print_dtitle_box(10, false, out, 1, "Membership: level two in the nested past temporal hierarchy of basis DD (PL₂(DD)).");
        print_oper_name(OP_PLC2, out);
        print_dmid_line(100, out);
        print_input_name(c, out);
        print_dmid_line(100, out);
        print_dline_box(0, out, " Characterizations :");
        print_dline_box(0, out, "  - Level one in the nested past temporal hierarchy of basis LT (PL(LT)).");
        print_dline_box(0, out, "  - Level one in the nested past temporal hierarchy of basis BPol(DD) (PL(BPol(DD))).");
        print_dline_box(0, out, "  - Level two in the nested past temporal hierarchy of basis DD (PL₂(DD)).");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose LT-orbits are R-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose BPol(DD)-orbits are R-trivial.");
        print_dline_box(0, out, "  - Languages with a syntactic morphism whose PL(DD)-orbits are R-trivial.");
        print_dbot_line(100, out);
        break;
    case CL_MOD:
        print_dtitle_box(10, false, out, 1,
